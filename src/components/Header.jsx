    ...
    return (
        <div id="header-container" className="flex justify-between items-center p-4">
            ...
            <div id="search-bar" className="relative w-full max-w-lg">
                ...
                />
                <FaSearch id="search-icon" className="absolute right-4 top-1/2 transform -translate-y-1/2 
                text-gray-300"/>
            </div>
            ...
            <div id="icons-container" className="flex items-center space-x-4">
                ...
                {/* Profile Section */}
                <div id="profile-container" className="flex items-center space-x-4 border-l pl-4 
                border-gray-300">
                    <span id="profile-text">
                        Hello, <b>Amanda Defya Putri</b>
                    </span>
                    <img
                        id="profile-avatar"
